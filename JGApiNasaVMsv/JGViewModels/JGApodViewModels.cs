...
using JGApiNasaVMsv.JGServices;
using System;
...
namespace JGApiNasaVMsv.JGViewModels
{
    public class JGApodViewModels : INotifyPropertyChanged
    {
        ...
        private JGApodService service;

        public JGApodService Service
        {
            get
            {
                if (service == null)
                {
                    service = new JGApodService();
                }
                return service;
            }
        }
        ...
        {
            JGModels.JGApod dto = await JGApodService.GetImage(day);
            if (dto == null)
            {
